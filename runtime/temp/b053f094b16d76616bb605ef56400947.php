<?php /*a:4:{s:70:"D:\Reer\myFrameRender\vueadmin\application\admin\view\index\index.html";i:1570972386;s:80:"D:\Reer\myFrameRender\vueadmin\application\common\view\layout\_meta_x-admin.html";i:1573736235;s:82:"D:\Reer\myFrameRender\vueadmin\application\common\view\layout\_header_x-admin.html";i:1573736276;s:80:"D:\Reer\myFrameRender\vueadmin\application\common\view\layout\_menu_x-admin.html";i:1570972389;}*/ ?>
<!doctype html>
...
<div class="container">
	...
	<ul class="layui-nav right" lay-filter="">
		<li class="layui-nav-item" style="margin-right: 20px;">
			<a href="javascript:;"><?php echo htmlentities(app('session')->get('username')); ?></a>
			<dl class="layui-nav-child">
				<!-- 二级菜单 -->
				<dd><a href="javascript:" onclick="my_message(this,'<?php echo htmlentities(app('session')->get('user_id')); ?>')">个人信息</a></dd>
...
<script>
	...
	function loginOut(type){
		$.ajax({
			...
			url: "<?php echo url('Login/loginOut'); ?>" ,//url
	...
	function my_message(obj,userId) {
		...
		index = layer.open({
			...
			area: ['80%', '80%'],
			content: "<?php echo url('NoCheckPermission/editSelfMessage'); ?>"
		})
	}
</script>
        <!-- 中部开始 -->
...
<div class="left-nav">
	<div id="side-nav">
		<ul id="nav">
			<?php if(is_array($permissionTree) || $permissionTree instanceof \think\Collection || $permissionTree instanceof \think\Paginator): $i = 0; $__LIST__ = $permissionTree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['is_play'] == 1): ?>
			<li>
				<a href="javascript:;">
					<i class="iconfont left-nav-li" lay-tips="<?php echo htmlentities($vo['name']); ?>"><?php echo $vo['icon']; ?></i>
					<cite><?php echo htmlentities($vo['name']); ?></cite>
					<i class="iconfont nav_right">&#xe697;</i>
				</a>
				<ul class="sub-menu">
					<?php if(is_array($vo['children']) || $vo['children'] instanceof \think\Collection || $vo['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['is_play']): ?>
					<li>
						<a onclick="xadmin.add_tab('<?php echo htmlentities($v['name']); ?>','<?php echo url($v['model'].'/'.$v['controller'].'/'.$v['action']); ?>')">
							<i class="iconfont">&#xe6a7;</i>
...
<!-- 左侧菜单结束 -->
        ...
        <span class="page-content-bg"></span>
    </body>
